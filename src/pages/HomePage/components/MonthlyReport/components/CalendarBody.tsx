 ...
 * 상위에서 내려받은 월간 데이터를 날짜별 활동 수로 매핑해 각 셀에 전달합니다.
 */
export function CalendarBody({ monthlyData }: { monthlyData: MonthlyData }) {
  ...
  // 월간 리포트 집계에 필요한 원본 데이터 (상위 MonthlyReportSection에서 조회)
